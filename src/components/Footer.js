...
const Footer = () => {
  ...
  return (
    <div className='max-w-7xl mx-auto px-4 py-5'>
        <footer className=' grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5'>
            <div className='p-5'>
                <img className='w-20' src="images/logo.jpg" alt="logo" />
                <h6 className='text-sm mt-2 text-slate-700 dark:text-slate-400'>Our cricket club is a community of passionate players and fans dedicated to promoting the spirit of cricket. We welcome players of all skill levels, host regular matches and training sessions, and aim to foster teamwork, sportsmanship, and a love for the game.</h6>
            </div>
            <div>
        ...
        <h6 className=' text-center text-sm text-slate-700 dark:text-slate-400'>© 2025 Copyright, Vk Cricket Club</h6>
    </div>
  )
}
